...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/q;)V
    ...
    .line 44
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/k;-><init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/q;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/s;

    .line 49
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/s;

    invoke-virtual {v0, p1}, Landroid/support/design/widget/s;->a(Landroid/view/View;)V

    .line 52
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/s;

    sget-object v1, Landroid/support/design/widget/i;->h:[I

    new-instance v2, Landroid/support/design/widget/i$b;

    invoke-direct {v2, p0, v3}, Landroid/support/design/widget/i$b;-><init>(Landroid/support/design/widget/i;Landroid/support/design/widget/i$1;)V

    invoke-direct {p0, v2}, Landroid/support/design/widget/i;->a(Landroid/view/animation/Animation;)Landroid/view/animation/Animation;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Landroid/support/design/widget/s;->a([ILandroid/view/animation/Animation;)V

    .line 54
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/s;

    sget-object v1, Landroid/support/design/widget/i;->i:[I
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/design/widget/i$c;-><init>(Landroid/support/design/widget/i;Landroid/support/design/widget/i$1;)V
...
.method private static a(I)Landroid/content/res/ColorStateList;
    ...
    .line 272
    sget-object v2, Landroid/support/design/widget/i;->i:[I
    ...
    .line 276
    sget-object v3, Landroid/support/design/widget/i;->h:[I
...
.method a(F)V
    ...
    iget v1, p0, Landroid/support/design/widget/i;->g:F
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    .line 106
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/i;->d:Landroid/support/design/widget/c;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 66
    invoke-virtual {p0}, Landroid/support/design/widget/i;->i()Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/drawable/Drawable;

    .line 78
    iget-object v0, p0, Landroid/support/design/widget/i;->c:Landroid/graphics/drawable/Drawable;

    invoke-static {p3}, Landroid/support/design/widget/i;->a(I)Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->d:Landroid/support/design/widget/c;
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->d:Landroid/support/design/widget/c;

    aput-object v1, v0, v7

    iget-object v1, p0, Landroid/support/design/widget/i;->b:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->k:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    iget-object v2, p0, Landroid/support/design/widget/i;->e:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Landroid/support/design/widget/i;->l:Landroid/support/design/widget/q;

    invoke-interface {v3}, Landroid/support/design/widget/q;->a()F

    move-result v3

    iget v4, p0, Landroid/support/design/widget/i;->f:F

    iget v5, p0, Landroid/support/design/widget/i;->f:F

    iget v6, p0, Landroid/support/design/widget/i;->g:F

    add-float/2addr v5, v6

    invoke-direct/range {v0 .. v5}, Landroid/support/design/widget/p;-><init>(Landroid/content/res/Resources;Landroid/graphics/drawable/Drawable;FFF)V
    ...
    .line 98
    iget-object v0, p0, Landroid/support/design/widget/i;->l:Landroid/support/design/widget/q;
...
.method a(Landroid/support/design/widget/k$a;Z)V
    ...
    .prologue
    .line 158
    iget-boolean v0, p0, Landroid/support/design/widget/i;->o:Z
...
.method b(F)V
    ...
    iget v1, p0, Landroid/support/design/widget/i;->f:F
