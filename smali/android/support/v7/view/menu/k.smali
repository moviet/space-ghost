...
# instance fields
.field private final mAdapter:Landroid/support/v7/view/menu/k$a;
...
.field private mPresenterCallback:Landroid/support/v7/view/menu/l$a;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/support/v7/view/menu/k;->ITEM_LAYOUT:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/f;Landroid/view/View;ZII)V
    ...
    iput v0, p0, Landroid/support/v7/view/menu/k;->mDropDownGravity:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->mInflater:Landroid/view/LayoutInflater;

    .line 96
    iput-object p2, p0, Landroid/support/v7/view/menu/k;->mMenu:Landroid/support/v7/view/menu/f;

    .line 97
    new-instance v0, Landroid/support/v7/view/menu/k$a;

    iget-object v1, p0, Landroid/support/v7/view/menu/k;->mMenu:Landroid/support/v7/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->mAdapter:Landroid/support/v7/view/menu/k$a;

    .line 98
    iput-boolean p4, p0, Landroid/support/v7/view/menu/k;->mOverflowOnly:Z

    .line 99
    iput p5, p0, Landroid/support/v7/view/menu/k;->mPopupStyleAttr:I

    .line 100
    iput p6, p0, Landroid/support/v7/view/menu/k;->mPopupStyleRes:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/k;->mPopupMaxWidth:I

    .line 106
    iput-object p3, p0, Landroid/support/v7/view/menu/k;->mAnchorView:Landroid/view/View;
...
.method static synthetic access$100(Landroid/support/v7/view/menu/k;)Z
    .locals 1

    .prologue
    .line 45
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->mOverflowOnly:Z

    return v0
.end method

.method static synthetic access$200(Landroid/support/v7/view/menu/k;)Landroid/view/LayoutInflater;
    .locals 1

    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mInflater:Landroid/view/LayoutInflater;

    return-object v0
.end method

.method static synthetic access$300(Landroid/support/v7/view/menu/k;)Landroid/support/v7/view/menu/f;
    .locals 1

    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mMenu:Landroid/support/v7/view/menu/f;
...
.method private measureContentWidth()I
    ...
    .line 204
    .line 208
    iget-object v6, p0, Landroid/support/v7/view/menu/k;->mAdapter:Landroid/support/v7/view/menu/k$a;
    ...
    .line 219
    :goto_1
    iget-object v4, p0, Landroid/support/v7/view/menu/k;->mMeasureParent:Landroid/view/ViewGroup;
    ...
    iget-object v10, p0, Landroid/support/v7/view/menu/k;->mContext:Landroid/content/Context;

    invoke-direct {v4, v10}, Landroid/widget/FrameLayout;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Landroid/support/v7/view/menu/k;->mMeasureParent:Landroid/view/ViewGroup;
    ...
    .line 227
    iget v10, p0, Landroid/support/v7/view/menu/k;->mPopupMaxWidth:I

    if-lt v0, v10, :cond_2

    .line 228
    iget v1, p0, Landroid/support/v7/view/menu/k;->mPopupMaxWidth:I
...
.method public dismiss()V
    ...
    .line 170
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mPopup:Landroid/support/v7/widget/ListPopupWindow;
...
.method public getGravity()I
    ...
    .prologue
    .line 125
    iget v0, p0, Landroid/support/v7/view/menu/k;->mDropDownGravity:I
...
.method public onCloseMenu(Landroid/support/v7/view/menu/f;Z)V
    ...
    .line 307
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mPresenterCallback:Landroid/support/v7/view/menu/l$a;
...
.method public onDismiss()V
    ...
    .line 175
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->mPopup:Landroid/support/v7/widget/ListPopupWindow;
    ...
    .line 177
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mAnchorView:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/k;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    .line 180
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->mTreeObserver:Landroid/view/ViewTreeObserver;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 190
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mAdapter:Landroid/support/v7/view/menu/k$a;
...
.method public onSubMenuSelected(Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/k;->mAnchorView:Landroid/view/View;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/view/menu/k;->setCallback(Landroid/support/v7/view/menu/l$a;)V
    ...
    .line 289
    :goto_1
    invoke-virtual {v3, v0}, Landroid/support/v7/view/menu/k;->setForceShowIcon(Z)V

    .line 291
    invoke-virtual {v3}, Landroid/support/v7/view/menu/k;->tryShow()Z
...
.method public setAnchorView(Landroid/view/View;)V
    ...
    .prologue
    .line 113
    iput-object p1, p0, Landroid/support/v7/view/menu/k;->mAnchorView:Landroid/view/View;
...
.method public setCallback(Landroid/support/v7/view/menu/l$a;)V
    ...
    .prologue
    .line 271
    iput-object p1, p0, Landroid/support/v7/view/menu/k;->mPresenterCallback:Landroid/support/v7/view/menu/l$a;
...
.method public setForceShowIcon(Z)V
    ...
    .prologue
    .line 117
    iput-boolean p1, p0, Landroid/support/v7/view/menu/k;->mForceShowIcon:Z
...
.method public setGravity(I)V
    ...
    .prologue
    .line 121
    iput p1, p0, Landroid/support/v7/view/menu/k;->mDropDownGravity:I
...
.method public tryShow()Z
    ...
    iget v5, p0, Landroid/support/v7/view/menu/k;->mPopupStyleAttr:I

    iget v6, p0, Landroid/support/v7/view/menu/k;->mPopupStyleRes:I
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/k;->mPopup:Landroid/support/v7/widget/ListPopupWindow;

    .line 140
    iget-object v2, p0, Landroid/support/v7/view/menu/k;->mPopup:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/k;->mAdapter:Landroid/support/v7/view/menu/k$a;
    ...
    .line 145
    iget-object v2, p0, Landroid/support/v7/view/menu/k;->mAnchorView:Landroid/view/View;

    .line 146
    if-eqz v2, :cond_3

    .line 147
    iget-object v3, p0, Landroid/support/v7/view/menu/k;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/k;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget v2, p0, Landroid/support/v7/view/menu/k;->mDropDownGravity:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ListPopupWindow;->setDropDownGravity(I)V

    .line 156
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->mHasContentWidth:Z

    if-nez v0, :cond_2

    .line 157
    invoke-direct {p0}, Landroid/support/v7/view/menu/k;->measureContentWidth()I

    move-result v0

    iput v0, p0, Landroid/support/v7/view/menu/k;->mContentWidth:I

    .line 158
    iput-boolean v1, p0, Landroid/support/v7/view/menu/k;->mHasContentWidth:Z

    .line 161
    :cond_2
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->mPopup:Landroid/support/v7/widget/ListPopupWindow;

    iget v2, p0, Landroid/support/v7/view/menu/k;->mContentWidth:I
...
.method public updateMenuView(Z)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/k;->mHasContentWidth:Z
