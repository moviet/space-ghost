...
.method public a(I)Landroid/support/v7/view/menu/h;
    ...
    # getter for: Landroid/support/v7/view/menu/k;->mOverflowOnly:Z
    invoke-static {v0}, Landroid/support/v7/view/menu/k;->access$100(Landroid/support/v7/view/menu/k;)Z
...
.method a()V
    ...
    # getter for: Landroid/support/v7/view/menu/k;->mMenu:Landroid/support/v7/view/menu/f;
    invoke-static {v0}, Landroid/support/v7/view/menu/k;->access$300(Landroid/support/v7/view/menu/k;)Landroid/support/v7/view/menu/f;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    # getter for: Landroid/support/v7/view/menu/k;->mInflater:Landroid/view/LayoutInflater;
    invoke-static {v0}, Landroid/support/v7/view/menu/k;->access$200(Landroid/support/v7/view/menu/k;)Landroid/view/LayoutInflater;

    move-result-object v0

    sget v1, Landroid/support/v7/view/menu/k;->ITEM_LAYOUT:I
    ...
    iget-boolean v2, v2, Landroid/support/v7/view/menu/k;->mForceShowIcon:Z
