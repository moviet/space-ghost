...
# instance fields
.field mCurrentExpandedItem:Landroid/support/v7/view/menu/h;

.field mMenu:Landroid/support/v7/view/menu/f;
...
.method public collapseItemActionView(Landroid/support/v7/view/menu/f;Landroid/support/v7/view/menu/h;)Z
    ...
    .line 2045
    iput-object v2, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/h;
...
.method public expandItemActionView(Landroid/support/v7/view/menu/f;Landroid/support/v7/view/menu/h;)Z
    ...
    .line 2012
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/h;
...
.method public initForMenu(Landroid/content/Context;Landroid/support/v7/view/menu/f;)V
    ...
    .prologue
    .line 1952
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/f;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/h;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/h;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/f;->d(Landroid/support/v7/view/menu/h;)Z

    .line 1955
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/f;
...
.method public updateMenuView(Z)V
    ...
    .line 1969
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/f;
    ...
    .line 1972
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mMenu:Landroid/support/v7/view/menu/f;
    ...
    .line 1973
    iget-object v4, p0, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->mCurrentExpandedItem:Landroid/support/v7/view/menu/h;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter;->collapseItemActionView(Landroid/support/v7/view/menu/f;Landroid/support/v7/view/menu/h;)Z
